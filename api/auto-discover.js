...
// 카테고리별 시드 키워드 (API 실패 fallback)
const CAT_SEEDS = {
  '50000000':['원피스','청바지','맨투맨','후드티','코트'],
  '50000001':['운동화','크로스백','반지갑','선글라스','벨트'],
  '50000002':['선크림','토너패드','비타민C세럼','쿠션팩트','클렌징폼'],
  '50000003':['무선이어폰','로봇청소기','공기청정기','스마트워치','태블릿'],
  '50000004':['스탠딩책상','패브릭소파','간접조명','수납장','침대프레임'],
  '50000005':['기저귀','분유','아기물티슈','유모차','유아식판'],
  '50000006':['단백질쉐이크','그래놀라','냉동삼겹살','견과류','오트밀'],
  '50000007':['요가매트','러닝화','등산스틱','헬스장갑','폼롤러'],
  '50000008':['마사지건','안마의자','혈압계','유산균','콜라겐'],
};
